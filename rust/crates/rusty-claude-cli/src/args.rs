...
use commands::{
    build_simplify_prompt, classify_skills_slash_command, resolve_skill_invocation,
...
use crate::{
    build_runtime_plugin_state_with_loader, is_background_task_tool_name,
    normalize_permission_mode, AllowedToolSet, CLI_OPTION_SUGGESTIONS, DEFAULT_DATE, DEFAULT_MODEL,
...
pub(crate) fn prompt_slash_turn_policy(command_name: &str) -> TurnExecutionPolicy {
...
pub(crate) fn format_prompt_slash_command_input(command_name: &str, args: Option<&str>) -> String {
...
pub(crate) fn format_prompt_slash_command_metadata(
    command_name: &str,
    args: Option<&str>,
) -> String {
    let mut lines = vec![
...
pub(crate) fn format_prompt_slash_skill_listing(skills_listing: &Value) -> Option<String> {
...
pub(crate) fn filter_tool_specs_for_request(
    tool_registry: &GlobalToolRegistry,
    allowed_tools: Option<&AllowedToolSet>,
