...
mod tests {
    use super::{
        ...
        filter_tool_specs_for_request, format_bughunter_report, format_commit_preflight_report,
        ...
        parse_git_status_branch, parse_git_status_metadata_for, parse_git_workspace_summary,
        parse_history_count, permission_policy, print_help_to, render_config_report,
