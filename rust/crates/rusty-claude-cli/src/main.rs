...
use api::{
    apply_message_cache_controls, oauth_token_is_expired, resolve_startup_auth_source, AuthSource,
};
...
use provider_client::AnthropicRuntimeClient;
...
use runtime::{
    ...
    ResolvedPermissionMode, RuntimeError, Session, TokenUsage, TurnExecutionPolicy, UsageTracker,
};
use runtime_host::{
    build_plugin_manager, build_runtime, build_runtime_plugin_state_with_loader,
    build_runtime_with_plugin_state, build_system_prompt, permission_policy, BuiltRuntime,
...
mod tests {
    use super::{
        ...
        format_permissions_switch_report, format_pr_report, format_prompt_slash_command_input,
        format_prompt_slash_command_metadata, format_prompt_slash_skill_listing,
        format_resume_report, format_status_report, format_tool_call_start, format_tool_result,
        format_ultraplan_report, format_unknown_slash_command,
        format_unknown_slash_command_message, merge_prompt_with_stdin, normalize_permission_mode,
        ...
        resolve_repl_model, resolve_session_reference, resume_supported_slash_commands,
    ...
    use crate::provider_client::{
        convert_messages, debug_json_input_summary, format_user_visible_api_error,
        normalize_tool_input_string, push_output_block, response_to_events,
    ...
    use crate::repl::{
        build_prompt_slash_command_initial_messages, format_internal_prompt_progress_line,
        InternalPromptProgressEvent, InternalPromptProgressState, LiveCli, PromptHistoryEntry,
    };
    use api::{
...
UU conflicted.rs",
    ...
    fn cache_control_keeps_stable_anchor_across_context_growth() {
        ...
        let mut request_two = convert_messages(&turn_two);
        ...
        let mut request_three = convert_messages(&turn_three);
