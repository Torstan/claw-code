...
#[cfg(test)]
mod tests {
    use super::{build_simplify_prompt, SIMPLIFY_PROMPT};

    #[test]
    fn build_simplify_prompt_without_args_returns_base_prompt() {
        assert_eq!(build_simplify_prompt(None), SIMPLIFY_PROMPT);
        assert_eq!(build_simplify_prompt(Some("   ")), SIMPLIFY_PROMPT);
    }

    #[test]
    fn build_simplify_prompt_with_args_appends_additional_focus() {
